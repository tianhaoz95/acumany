...
export function svg_to_pdf(svg, callback) {
  svgAsDataUri(svg, {}, function(svg_uri) {
    ...
    image.onload = function() {
      ...
      // pdf default export ratio is 3/4
      var adjustedWidth = Math.trunc(845 * 0.75);
      var adjustedHeight = Math.trunc(595 * 0.75);
      ...
      doc.addImage(dataUrl, 'JPEG', 0, 0, adjustedWidth, adjustedHeight);
